...
module.exports = async function (req, res) {
  ...
  var urlPath = "/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false";
   //urlPath =  "/v3/ping";
  ...
  try {
    ...
    for (i=0; i< rs.length; i++){
      ...
      //         data,
      //       });
      let promise = database.updateDocument('626404fbd4a313275970', rs[i]['id'], data);
      // let promise = database.updateDocument('62570e57e2a43a6a23ab',rs[i]['id'], data);
